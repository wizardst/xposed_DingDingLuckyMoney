...
public class VersionParam {
    ...
    public static String ApiEventListener = "arw";
    public static String ConversationChangeMaid = "bfk";
    public static String ServiceFactory = "dkv";
    public static String RedPacketsRpc = "amj";
