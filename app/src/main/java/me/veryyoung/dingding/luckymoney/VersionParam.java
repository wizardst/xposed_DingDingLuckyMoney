...
public class VersionParam {
    ...
    public static String ApiEventListener = "cjy";
    public static String ConversationChangeMaid = "dhh";
    public static String ServiceFactory = "ipx";
    public static String RedPacketsRpc = "caq";
    public static String MessageDs = "hsw";
    ...
    public static void init(String version) {
        switch (version) {
            ...
            case "4.2.8":
                ...
                break;
            case "4.3.0":
                ApiEventListener = "buk";
                ConversationChangeMaid = "cmw";
                ServiceFactory = "gsk";
                RedPacketsRpc = "bmm";
                MessageDs = "fzs";
                break;
            ...
            case "4.3.6":
                ...
                break;
            case "4.3.7":
                ApiEventListener = "bye";
                ConversationChangeMaid = "csd";
                ServiceFactory = "hhl";
                RedPacketsRpc = "bpu";
                MessageDs = "gln";
                break;
            case "4.3.10":
                ApiEventListener = "byr";
                ConversationChangeMaid = "csw";
                ServiceFactory = "hij";
                RedPacketsRpc = "bqf";
                MessageDs = "gmg";
                break;
            case "4.5.18":
                ApiEventListener = "cjy";
                ConversationChangeMaid = "dhh";
                ServiceFactory = "ipx";
                RedPacketsRpc = "caq";
                MessageDs = "hsw";
                break;
